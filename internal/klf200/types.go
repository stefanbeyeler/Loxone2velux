...
const (
	...
	// Device discovery
	GW_GET_ALL_NODES_INFORMATION_REQ     CommandID = 0x0200
	GW_GET_ALL_NODES_INFORMATION_CFM     CommandID = 0x0201
	GW_GET_ALL_NODES_INFORMATION_NTF     CommandID = 0x0202
	GW_GET_ALL_NODES_INFORMATION_FINISHED_NTF CommandID = 0x0203
